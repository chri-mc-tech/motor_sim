...
void ffb_init() {
    ...
    if (FAILED(DirectInput8Create(GetModuleHandle(NULL), DIRECTINPUT_VERSION, IID_IDirectInput8, (LPVOID*)&pDI, NULL))) {
        return;
    }

    pDI->EnumDevices(DI8DEVCLASS_GAMECTRL, [](LPCDIDEVICEINSTANCE pInst, LPVOID Ctx) -> BOOL {
